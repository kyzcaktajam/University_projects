 ...
 *
 * @authors Marcin Peczarski <marpe@mimuw.edu.pl>, Maja Tkaczyk <mt438772@students.mimuw.edu.pl>
...
/**
 * To jest struktura przechowująca stos cyfr.
 */
struct Stack;
...
/** @brief Wyznacza numery przekierowywane na dany numer.
 * Wyznacza następujący ciąg numerów: jeśli istnieje numer @p x, taki, że
 * istnieje takie przekierowanie, że po przekierowaniu numeru @p x otrzymamy
 * numer @p num, to numer @p x należy do wyniku wywołania @ref phfwdReverse 
 * z numerem @p num. 
 * Dodatkowo ciąg wynikowy zawsze zawiera też numer @p num. 
 ...
 * należy do wyniku wywołania @ref phfwdGetReverse z numerem @p num. Wynikowe
 * numery są posortowane leksykograficznie i nie mogą się powtarzać.
 * Jeśli podany napis nie reprezentuje numeru, wynikiem jest pusty ciąg. 
 * Alokuje strukturę @p PhoneNumbers, która musi być zwolniona za pomocą funkcji 
 * @ref phnumDelete.
 * @param[in] pf  – wskaźnik na strukturę przechowującą przekierowania numerów;
 * @param[in] num – wskaźnik na napis reprezentujący numer.
 * @return Wskaźnik na strukturę przechowującą ciąg numerów lub NULL, gdy nie
